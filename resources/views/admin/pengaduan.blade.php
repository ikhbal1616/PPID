...
<head>
    ...
    <title>Pengaduan Layanan Kampus | Admin PPID Universitas Baiturrahmah</title>
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- Meta SEO -->
    <meta name="description" content="Kelola pengaduan layanan kampus secara efisien.">
        ...
        <aside id="admin-sidebar" class="w-64 bg-brand-green-950 text-slate-300 flex-shrink-0 flex flex-col justify-between transition-all duration-300 z-30 fixed top-0 bottom-0 left-0 -translate-x-full lg:translate-x-0 h-screen shadow-2xl">
            <div>
                ...
                <nav class="p-4 space-y-1.5 text-xs font-semibold">
                    ...
                    <a href="/admin/keberatan" id="side-keberatan" class="sidebar-item flex items-center space-x-3 hover:bg-brand-green-900/40 hover:text-white px-3 py-3 rounded-lg transition-all text-slate-400">
                    ...
                    <a href="/admin/pengaduan" id="side-pengaduan" class="sidebar-item flex items-center space-x-3 bg-brand-green-900/60 text-brand-gold-500 border-l-4 border-brand-gold-500 px-3 py-3 rounded-lg transition-all">
        ...
        <div class="flex-1 flex flex-col min-h-screen pl-0 lg:pl-64 transition-all duration-300 overflow-y-auto">
            ...
            <main class="p-6 space-y-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between space-y-2 md:space-y-0">
                    <div>
                        <h1 class="text-2xl font-bold font-display tracking-tight text-slate-900 leading-tight">Pengaduan Layanan Kampus</h1>
                        <p class="text-slate-500 text-xs">Kelola verifikasi, tanggapan, dan penyelesaian pengaduan layanan kampus secara online.</p>
                    </div>
