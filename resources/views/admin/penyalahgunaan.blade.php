...
<head>
    ...
    <title>Penyalahgunaan Wewenang | Admin PPID Universitas Baiturrahmah</title>
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- Meta SEO -->
    <meta name="description" content="Kelola penyalahgunaan wewenang secara efisien.">
        ...
        <aside id="admin-sidebar" class="w-64 bg-brand-green-950 text-slate-300 flex-shrink-0 flex flex-col justify-between transition-all duration-300 z-30 fixed top-0 bottom-0 left-0 -translate-x-full lg:translate-x-0 h-screen shadow-2xl">
            <div>
                ...
                <nav class="p-4 space-y-1.5 text-xs font-semibold">
                    ...
                    <a href="/admin/penyalahgunaan" id="side-penyalahgunaan" class="sidebar-item flex items-center space-x-3 bg-brand-green-900/60 text-brand-gold-500 border-l-4 border-brand-gold-500 px-3 py-3 rounded-lg transition-all">
