...
<head>
    ...
    <title>Informasi Publik Berkala | Universitas Baiturrahmah</title>
    <!-- Meta SEO -->
    <meta name="description" content="Informasi Publik Berkala yang disediakan oleh Pejabat Pengelola Informasi dan Dokumentasi (PPID) Universitas Baiturrahmah secara transparan, akurat, dan dapat diakses.">
    <meta name="keywords" content="Informasi Berkala PPID, Dokumen PPID, Universitas Baiturrahmah, Unbrah">
            ...
            <div class="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 py-3.5 flex justify-between items-center">
                ...
                <nav class="hidden lg:flex items-center space-x-8 font-semibold text-sm text-brand-green-950">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-1 w-56 rounded-xl bg-white shadow-xl border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 p-2 z-50">
                            <a href="/informasi-publik-berkala" class="block px-4 py-2 text-xs rounded-lg hover:bg-brand-green-50 hover:text-brand-green-700 transition-colors bg-brand-green-50/50 text-brand-green-700 font-bold">Informasi Publik Berkala</a>
            ...
            <div id="mobile-menu" class="hidden lg:hidden border-t border-slate-100 bg-white shadow-inner max-h-[80vh] overflow-y-auto">
                <div class="px-4 py-3 space-y-2 text-sm font-semibold text-brand-green-950">
                    ...
                    <div>
                        ...
                        <a href="/informasi-publik-berkala" class="block py-2 pl-4 text-xs text-brand-green-600 font-bold">Informasi Publik Berkala</a>
    ...
    <section class="relative bg-gradient-to-br from-brand-green-950 to-brand-green-900 py-12 text-white overflow-hidden shadow-xl">
        <div class="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 text-center relative z-10 space-y-3">
            <h1 class="text-3xl sm:text-5xl md:text-6xl font-bold font-display tracking-tight text-white leading-tight drop-shadow">
                Informasi Publik Berkala <br class="hidden sm:inline">
            ...
            <p class="text-base md:text-lg text-slate-300/90 max-w-none mx-auto font-light leading-relaxed">
                Akses dokumen keterbukaan informasi publik secara berkala, transparan, dan akuntabel sesuai amanat UU No. 14 Tahun 2008.
            </p>
        </div>
    </section>
        ...
        <div class="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 relative z-10 space-y-12">
            ...
            <div class="w-full">
                ...
                <div class="relative max-w-xl mx-auto">
                    <input type="text" id="doc-search" placeholder="Cari berkas/dokumen (contoh: Renstra, Keputusan Rektor)..." class="w-full bg-slate-50 border border-slate-200 focus:border-brand-green-500 focus:bg-white text-slate-800 text-sm pl-12 pr-4 py-3.5 rounded-2xl shadow-sm outline-none transition-all duration-300">
            ...
            <div id="docs-accordion" class="w-full space-y-4">
                @php
                    $informasiBerkalaRaw = setting('informasi_berkala_list');
                    $informasiBerkalaList = [];
                    if ($informasiBerkalaRaw) {
                        $informasiBerkalaList = json_decode($informasiBerkalaRaw, true);
                    }
                    if (empty($informasiBerkalaList)) {
                        $informasiBerkalaList = [
                            [
                ...
                @foreach ($informasiBerkalaList as $index => $item)
                    @php
