...
<head>
    ...
    <title>PPID Dalam Angka | Universitas Baiturrahmah</title>
    <!-- Meta SEO -->
    <meta name="description" content="Statistik dan data pelayanan informasi publik di PPID Universitas Baiturrahmah. Grafik permohonan masuk, status penyelesaian, dan kategori pemohon.">
    <meta name="keywords" content="PPID Dalam Angka, Statistik PPID, Data Layanan PPID, Universitas Baiturrahmah, Unbrah">
                ...
                <nav class="hidden lg:flex items-center space-x-8 font-semibold text-sm text-brand-green-950">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-1 w-56 rounded-xl bg-white shadow-xl border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 p-2 z-50">
                            ...
                            <a href="/ppid-dalam-angka" class="block px-4 py-2 text-xs rounded-lg hover:bg-brand-green-50 hover:text-brand-green-700 transition-colors bg-brand-green-50/50 text-brand-green-700 font-bold">PPID Dalam Angka</a>
            ...
            <div id="mobile-menu" class="hidden lg:hidden border-t border-slate-100 bg-white shadow-inner max-h-[80vh] overflow-y-auto">
                <div class="px-4 py-3 space-y-2 text-sm font-semibold text-brand-green-950">
                    ...
                    <div>
                        ...
                        <a href="/ppid-dalam-angka" class="block py-2 pl-4 text-xs text-brand-green-600 font-bold">PPID Dalam Angka</a>
