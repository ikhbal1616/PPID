...
<head>
    ...
    <title>Visi & Misi | PPID Universitas Baiturrahmah</title>
    <!-- Meta SEO -->
    <meta name="description" content="Visi dan Misi resmi Pejabat Pengelola Informasi dan Dokumentasi (PPID) Universitas Baiturrahmah. Komitmen kami untuk mewujudkan transparansi dan keterbukaan informasi publik.">
    <meta name="keywords" content="Visi Misi PPID, Universitas Baiturrahmah, Unbrah, Keterbukaan Informasi">
...
<body class="bg-slate-50 text-slate-800 font-sans antialiased overflow-x-hidden">
                ...
                <nav class="hidden lg:flex items-center space-x-8 font-semibold text-sm text-brand-green-950">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-1 w-56 rounded-xl bg-white shadow-xl border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 p-2 z-50">
                            ...
                            <a href="/visi-misi" class="block px-4 py-2 text-xs rounded-lg hover:bg-brand-green-50 hover:text-brand-green-700 transition-colors bg-brand-green-50/50 text-brand-green-700 font-bold">Visi & Misi PPID</a>
            ...
            <div id="mobile-menu" class="hidden lg:hidden border-t border-slate-100 bg-white shadow-inner max-h-[80vh] overflow-y-auto">
                <div class="px-4 py-3 space-y-2 text-sm font-semibold text-brand-green-950">
                    ...
                    <div>
                        ...
                        <a href="/visi-misi" class="block py-2 pl-4 text-xs text-brand-green-600 font-bold">Visi & Misi PPID</a>
    ...
    <!-- FOOTER -->
    <footer class="bg-brand-green-950 text-slate-400 py-16 border-t border-brand-green-900">
        <div class="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-12">
            <!-- Footer Top -->
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-12 border-b border-slate-900">
                <!-- Column 1: Institutional Info (Col span 4) -->
                <div class="lg:col-span-4 space-y-6">
                    <div class="flex items-center space-x-4">
                        <img src="/images/logo_unbrah.png" alt="Logo Universitas Baiturrahmah" class="w-24 h-24 object-contain">
                        <div class="flex flex-col">
                            <span class="text-2xl md:text-3xl font-bold text-white leading-tight">PPID UNBRAH</span>
                            <span class="text-[10px] text-brand-gold-500 uppercase tracking-widest mt-1">Universitas Baiturrahmah Padang</span>
                        </div>
                    </div>
                    <p class="text-xs text-slate-400 leading-relaxed text-justify">
                        Pejabat Pengelola Informasi dan Dokumentasi (PPID) Universitas Baiturrahmah berkomitmen memberikan akses informasi publik secara cepat, transparan, akurat, dan akuntabel sesuai dengan UU No. 14 Tahun 2008.
                    </p>
    ...
    <script>
        // --- 1. ACCORDION LOGIC ---
        // (Accordion is not used in Visi & Misi but script is kept for general integrity)
        ...
        // --- 3. MODAL FORM INTERACTIVE LOGIC ---
